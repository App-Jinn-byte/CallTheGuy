//
//  CompletedJobsTableViewCell.swift
//  Call The Guy
//
...
class CompletedJobsTableViewCell: UITableViewCell {
    ...
    @IBAction func onJobDetailPressed(_ sender: UIButton) {
        
        guard let detail = self.jobObject else { return }
        
        self.delegate?.onJobDetailButtonPressed(jobDetail: detail)
    }
